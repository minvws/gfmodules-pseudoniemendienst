...
# OAuth scope required for this endpoint
REQUIRED_SCOPE = "prs:saml-reversible-pseudonym"
...
Requires the `prs:saml-reversible-pseudonym` OAuth scope; the token (and its
scopes) are validated upstream by the OIN-verifier proxy.
""",
)
